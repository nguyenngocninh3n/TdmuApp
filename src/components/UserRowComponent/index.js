...
const UserRowComponent = ({onPress, name, avatar, textSize, avatarSize, padding, margin, height, spacing, children, detail }) => {
  return (
    <RowComponent style={{height, padding, margin}}>
      <AvatarComponent onPress={onPress} source={avatar} size={avatarSize} />
